    ...
    <>
      <div>
        ...
        <div className="lg:px-10 px-5 py-20">
          ...
          <div data-aos="fade-up" className='lg:text-2xl text-xl mt-20 mb-3 w-[90%] lg:w-[20%] border rounded-xl border-black uppercase p-3 font-bold text-center font-nunito '>nimble&rsquo;s features</div>
            <One /> 
            <Two />
             <Three />
          </div>
